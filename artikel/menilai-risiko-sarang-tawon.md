---
article_id: BAS-09-A02
title: "Menilai Risiko Sarang Tawon di Atap, Tanah, Pohon, dan Rongga"
slug: "menilai-risiko-sarang-tawon"
description: "Evaluate activity, access, occupants, children, work routes, indoor entry, height, and safe isolation"
status: outline
publication_date: "2025-10-28"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: BAS-09
primary_intent: "Assess nest risk"
reader_community: "Basmi.co.id"
reader_address: "Sobat Basmi.co.id"
final_route: "/artikel/menilai-risiko-sarang-tawon.html"
...
# Menilai Risiko Sarang Tawon di Atap, Tanah, Pohon, dan Rongga

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Menilai Risiko Sarang Tawon di Atap, Tanah, Pohon, dan Rongga”
- **Reader and situation:** Owner finding a nest
- **Reader outcome:** Evaluate activity, access, occupants, children, work routes, indoor entry, height, and safe isolation
- **Primary intent:** Assess nest risk
...
- **Scope boundary:** Excludes nest disturbance or allergy diagnosis; BAS-09-A03 owns professional response
- **Final public route:** `/artikel/menilai-risiko-sarang-tawon.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Menilai Risiko Sarang Tawon di Atap, Tanah, Pohon, dan Rongga**.
...
- `/jasa-pembasmi-tawon-tanah-laut.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-pembasmi-tawon-tanah-laut` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-pembasmi-tawon-tanah-datar.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-pembasmi-tawon-tanah-datar` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-pembasmi-tawon-tanah-bumbu.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-pembasmi-tawon-tanah-bumbu` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- **Tie back to this article:** Keep the explanation specific to “Menilai Risiko Sarang Tawon di Atap, Tanah, Pohon, dan Rongga”.
