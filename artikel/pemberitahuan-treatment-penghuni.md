---
article_id: BAS-15-A02
title: "Pemberitahuan Treatment untuk Penghuni, Tetangga, dan Pengelola Gedung"
slug: "pemberitahuan-treatment-penghuni"
description: "Provide scope, timing, access, preparation, product disclosure route, re-entry confirmation, contacts, and incident reporting"
status: outline
publication_date: "2026-03-30"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: BAS-15
primary_intent: "Communicate treatment controls"
reader_community: "Basmi.co.id"
reader_address: "Teman Basmi.co.id"
final_route: "/artikel/pemberitahuan-treatment-penghuni.html"
...
# Pemberitahuan Treatment untuk Penghuni, Tetangga, dan Pengelola Gedung

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Pemberitahuan Treatment untuk Penghuni, Tetangga, dan Pengelola Gedung”
- **Reader and situation:** Multi-occupant building
- **Reader outcome:** Provide scope, timing, access, preparation, product disclosure route, re-entry confirmation, contacts, and incident reporting
- **Primary intent:** Communicate treatment controls
...
- **Scope boundary:** Excludes universal notice periods or legal consent rules; BAS-18 and local management own requirements
- **Final public route:** `/artikel/pemberitahuan-treatment-penghuni.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Pemberitahuan Treatment untuk Penghuni, Tetangga, dan Pengelola Gedung**.
...
- `BAS-15-A01` → `/artikel/penghuni-sensitif-sebelum-treatment-hama.html` — Anak, Kehamilan, Lansia, Asma, dan Alergi: Pertanyaan Sebelum Treatment
...
- **Tie back to this article:** Keep the explanation specific to “Pemberitahuan Treatment untuk Penghuni, Tetangga, dan Pengelola Gedung”.
