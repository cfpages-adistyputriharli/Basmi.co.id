---
article_id: BAS-04-A02
title: "Survei Kecoa di Dapur, Kamar Mandi, dan Ruang Mesin"
slug: "survei-kecoa-di-bangunan"
description: "Inspect heat, water, food, voids, drains, equipment, packaging, and adjacent-unit pathways"
status: outline
publication_date: "2025-07-03"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: BAS-04
primary_intent: "Plan a cockroach inspection"
reader_community: "Basmi.co.id"
reader_address: "Kawan Basmi.co.id"
final_route: "/artikel/survei-kecoa-di-bangunan.html"
...
# Survei Kecoa di Dapur, Kamar Mandi, dan Ruang Mesin

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Survei Kecoa di Dapur, Kamar Mandi, dan Ruang Mesin”
- **Reader and situation:** Home or facility team
- **Reader outcome:** Inspect heat, water, food, voids, drains, equipment, packaging, and adjacent-unit pathways
- **Primary intent:** Plan a cockroach inspection
...
- **Scope boundary:** Excludes food audit requirements; BAS-16-A02 owns food-site controls
- **Final public route:** `/artikel/survei-kecoa-di-bangunan.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Survei Kecoa di Dapur, Kamar Mandi, dan Ruang Mesin**.
...
- **Exact Markdown to insert:** `![Ilustrasi jasa basmi kecoa 3](/wp-content/uploads/2023/11/jasa-basmi-kecoa-3.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `jasa basmi kecoa 3` as relevant content media; no pixels were inspected.
...
- `BAS-04-A01` → `/artikel/kecoa-jerman-vs-kecoa-amerika.html` — Kecoa Jerman atau Kecoa Amerika: Identifikasi Awal dan Lokasi Persembunyian
...
- **Tie back to this article:** Keep the explanation specific to “Survei Kecoa di Dapur, Kamar Mandi, dan Ruang Mesin”.
