---
article_id: BAS-03-A02
title: "Tikus Atap, Tikus Got, dan Mencit: Mengapa Identifikasi Mengubah Strategi"
slug: "jenis-tikus-dan-mencit-di-bangunan"
description: "Compare body/sign clues, movement zones, food, nesting, and uncertainty relevant to inspection"
status: outline
publication_date: "2025-06-06"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: BAS-03
primary_intent: "Distinguish rodent ecology"
reader_community: "Basmi.co.id"
reader_address: "Sobat Basmi.co.id"
final_route: "/artikel/jenis-tikus-dan-mencit-di-bangunan.html"
...
# Tikus Atap, Tikus Got, dan Mencit: Mengapa Identifikasi Mengubah Strategi

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Tikus Atap, Tikus Got, dan Mencit: Mengapa Identifikasi Mengubah Strategi”
- **Reader and situation:** Facility with repeated activity
- **Reader outcome:** Compare body/sign clues, movement zones, food, nesting, and uncertainty relevant to inspection
- **Primary intent:** Distinguish rodent ecology
...
- **Scope boundary:** Excludes certainty from droppings alone; BAS-01-A05 owns specialist identification
- **Final public route:** `/artikel/jenis-tikus-dan-mencit-di-bangunan.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Tikus Atap, Tikus Got, dan Mencit: Mengapa Identifikasi Mengubah Strategi**.
...
- **Exact Markdown to insert:** `![Ilustrasi Basmi Tikus](/wp-content/uploads/2023/11/Basmi-Tikus.jpg)`
...
- `BAS-03-A01` → `/artikel/tanda-tikus-dan-jalur-masuk.html` — Tanda Tikus dan Cara Memetakan Jalur Masuk
- `BAS-03-A03` → `/artikel/proofing-bangunan-untuk-tikus.html` — Proofing Bangunan untuk Tikus: Celah, Pintu, Pipa, dan Atap
- `BAS-03-A04` → `/artikel/perangkap-monitoring-dan-rodentisida.html` — Perangkap, Monitoring, dan Rodentisida: Cara Memilih Pendekatan Tikus
...
- **Tie back to this article:** Keep the explanation specific to “Tikus Atap, Tikus Got, dan Mencit: Mengapa Identifikasi Mengubah Strategi”.
