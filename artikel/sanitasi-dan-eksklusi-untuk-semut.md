---
article_id: BAS-05-A03
title: "Sanitasi dan Eksklusi untuk Semut di Dapur"
slug: "sanitasi-dan-eksklusi-untuk-semut"
description: "Prioritize spills, residues, storage, moisture, waste, cracks, and follow-up monitoring"
status: outline
publication_date: "2025-07-28"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: BAS-05
primary_intent: "Prevent kitchen ant activity"
reader_community: "Basmi.co.id"
reader_address: "Kawan Basmi.co.id"
final_route: "/artikel/sanitasi-dan-eksklusi-untuk-semut.html"
...
# Sanitasi dan Eksklusi untuk Semut di Dapur

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Sanitasi dan Eksklusi untuk Semut di Dapur”
- **Reader and situation:** Home or food-site operator
- **Reader outcome:** Prioritize spills, residues, storage, moisture, waste, cracks, and follow-up monitoring
- **Primary intent:** Prevent kitchen ant activity
...
- **Scope boundary:** Excludes food-site compliance and chemical treatment; BAS-16-A02 and BAS-05-A04 own those
- **Final public route:** `/artikel/sanitasi-dan-eksklusi-untuk-semut.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Sanitasi dan Eksklusi untuk Semut di Dapur**.
...
- `BAS-05-A01` → `/artikel/semut-bersayap-vs-laron.html` — Semut Bersayap atau Laron: Cara Membedakan Tanda Awal
- `BAS-05-A02` → `/artikel/membaca-jalur-semut.html` — Membaca Jalur Semut untuk Menemukan Sumber Makanan dan Titik Masuk
- `BAS-05-A04` → `/artikel/bait-vs-spray-untuk-semut.html` — Bait dan Spray untuk Semut: Mengapa Respons Koloni Bisa Berbeda
- `BAS-05-A05` → `/artikel/penyebab-semut-terus-kembali.html` — Semut Terus Kembali: Sumber, Koloni Satelit, dan Area Tetangga
...
- **Tie back to this article:** Keep the explanation specific to “Sanitasi dan Eksklusi untuk Semut di Dapur”.
