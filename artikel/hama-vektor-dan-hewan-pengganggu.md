---
article_id: BAS-00-A03
title: "Hama, Vektor, dan Hewan Pengganggu: Istilah yang Tidak Sama"
slug: "hama-vektor-dan-hewan-pengganggu"
description: "Separate nuisance, damage, contamination, vector, and disease-carrying-animal concepts"
status: outline
publication_date: "2025-04-05"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: BAS-00
primary_intent: "Distinguish core terms"
reader_community: "Basmi.co.id"
reader_address: "Kawan Basmi.co.id"
final_route: "/artikel/hama-vektor-dan-hewan-pengganggu.html"
...
# Hama, Vektor, dan Hewan Pengganggu: Istilah yang Tidak Sama

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Hama, Vektor, dan Hewan Pengganggu: Istilah yang Tidak Sama”
- **Reader and situation:** Reader interpreting service claims
- **Reader outcome:** Separate nuisance, damage, contamination, vector, and disease-carrying-animal concepts
- **Primary intent:** Distinguish core terms
...
- **Scope boundary:** Excludes declaring a disease risk from a sighting; BAS-01-A04 owns risk assessment
- **Final public route:** `/artikel/hama-vektor-dan-hewan-pengganggu.html`
- **Appointed CMS date:** `2025-04-05` (`editorial_backfill`; preserve exactly)
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Hama, Vektor, dan Hewan Pengganggu: Istilah yang Tidak Sama**.
...
- `BAS-00-A01` → `/artikel/apa-itu-integrated-pest-management.html` — Apa Itu Integrated Pest Management dan Mengapa Bukan Sekadar Semprot
- `BAS-00-A02` → `/artikel/siklus-pengendalian-hama.html` — Siklus Pengendalian Hama dari Survei hingga Evaluasi Ulang
- `BAS-00-A04` → `/artikel/ambang-tindakan-pengendalian-hama.html` — Ambang Tindakan: Kapan Dipantau, Diperbaiki, atau Dikendalikan
- `BAS-00-A05` → `/artikel/penyebab-hama-muncul-kembali.html` — Mengapa Hama Muncul Lagi Setelah Treatment
...
- **Tie back to this article:** Keep the explanation specific to “Hama, Vektor, dan Hewan Pengganggu: Istilah yang Tidak Sama”.
