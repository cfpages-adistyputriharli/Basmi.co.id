---
article_id: BAS-02-A03
title: "Survei Rayap pada Bangunan Jadi: Area dan Bukti yang Perlu Dipetakan"
slug: "survei-rayap-bangunan-jadi"
description: "Map soil contact, plumbing, cracks, timber, ceilings, wet zones, inaccessible areas, and activity evidence"
status: outline
publication_date: "2025-05-18"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: BAS-02
primary_intent: "Plan post-construction survey"
reader_community: "Basmi.co.id"
reader_address: "Sobat Basmi.co.id"
final_route: "/artikel/survei-rayap-bangunan-jadi.html"
...
sources:
  ...
  - "https://www.fpl.fs.usda.gov/research/research_emphasis_areas/wood_protection.php"
...
# Survei Rayap pada Bangunan Jadi: Area dan Bukti yang Perlu Dipetakan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Survei Rayap pada Bangunan Jadi: Area dan Bukti yang Perlu Dipetakan”
- **Reader and situation:** Existing-building owner
- **Reader outcome:** Map soil contact, plumbing, cracks, timber, ceilings, wet zones, inaccessible areas, and activity evidence
- **Primary intent:** Plan post-construction survey
...
- **Scope boundary:** Excludes drilling/injection layout; licensed provider and product label own application
- **Final public route:** `/artikel/survei-rayap-bangunan-jadi.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Survei Rayap pada Bangunan Jadi: Area dan Bukti yang Perlu Dipetakan**.
...
- **Exact Markdown to insert:** `![Ilustrasi Basmi Rayap](/wp-content/uploads/2023/11/Basmi-Rayap.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Basmi Rayap` as relevant content media; no pixels were inspected.
...
- `/rayap` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-pembasmi-rayap.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-pembasmi-rayap-yalimo.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-pembasmi-rayap-yalimo` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-pembasmi-rayap-yahukimo.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-pembasmi-rayap-yahukimo` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `BAS-02-A01` → `/artikel/tanda-rayap-aktif.html` — Tanda Rayap Aktif dan Kapan Memanggil Profesional
- `BAS-02-A02` → `/artikel/rayap-tanah-vs-rayap-kayu-kering.html` — Rayap Tanah dan Rayap Kayu Kering: Perbedaan Bukti dan Survei
- `BAS-02-A04` → `/artikel/perbandingan-metode-pengendalian-rayap.html` — Baiting, Barrier Tanah, dan Treatment Lokal Rayap: Cara Membandingkan
...
- **Tie back to this article:** Keep the explanation specific to “Survei Rayap pada Bangunan Jadi: Area dan Bukti yang Perlu Dipetakan”.
