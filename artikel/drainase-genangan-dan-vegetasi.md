---
article_id: BAS-12-A03
title: "Talang, Drainase, Genangan, dan Vegetasi sebagai Sumber Masalah Hama"
slug: "drainase-genangan-dan-vegetasi"
description: "Connect water, organic matter, waste, canopy bridges, ground contact, and maintenance access to pest activity"
status: outline
publication_date: "2026-01-17"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: BAS-12
primary_intent: "Fix outdoor pest sources"
reader_community: "Basmi.co.id"
reader_address: "Teman Basmi.co.id"
final_route: "/artikel/drainase-genangan-dan-vegetasi.html"
...
# Talang, Drainase, Genangan, dan Vegetasi sebagai Sumber Masalah Hama

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Talang, Drainase, Genangan, dan Vegetasi sebagai Sumber Masalah Hama”
- **Reader and situation:** Property manager inspecting grounds
- **Reader outcome:** Connect water, organic matter, waste, canopy bridges, ground contact, and maintenance access to pest activity
- **Primary intent:** Fix outdoor pest sources
...
- **Scope boundary:** Excludes landscape/drainage engineering; BAS-08-A03 owns mosquito container survey
- **Final public route:** `/artikel/drainase-genangan-dan-vegetasi.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Talang, Drainase, Genangan, dan Vegetasi sebagai Sumber Masalah Hama**.
...
- `BAS-12-A01` → `/artikel/peta-kelembapan-dan-titik-masuk-hama.html` — Peta Kelembapan dan Titik Masuk Hama pada Bangunan
- `BAS-12-A02` → `/artikel/detail-eksklusi-hama-bangunan.html` — Eksklusi Hama: Pintu, Screen, Celah, Pipa, Drain, dan Penetrasi
- `BAS-12-A04` → `/artikel/kebocoran-kondensasi-dan-ruang-void.html` — Kebocoran Tersembunyi, Kondensasi, dan Ruang Void: Cara Menentukan Eskalasi
- `BAS-12-A05` → `/artikel/pencegahan-hama-saat-renovasi.html` — Renovasi Bangunan Tanpa Membuka Jalur Baru untuk Hama
...
- **Tie back to this article:** Keep the explanation specific to “Talang, Drainase, Genangan, dan Vegetasi sebagai Sumber Masalah Hama”.
