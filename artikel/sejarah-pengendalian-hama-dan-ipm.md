---
article_id: BAS-00-A06
title: "Dari Pembasmian Massal ke IPM: Evolusi Pengendalian Hama"
slug: "sejarah-pengendalian-hama-dan-ipm"
description: "Trace the shift from reactive chemical control toward prevention, evidence, and integrated methods"
status: outline
publication_date: "2025-04-17"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: BAS-00
primary_intent: "Understand IPM history"
reader_community: "Basmi.co.id"
reader_address: "Kawan Basmi.co.id"
final_route: "/artikel/sejarah-pengendalian-hama-dan-ipm.html"
...
# Dari Pembasmian Massal ke IPM: Evolusi Pengendalian Hama

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Dari Pembasmian Massal ke IPM: Evolusi Pengendalian Hama”
- **Reader and situation:** General reader
- **Reader outcome:** Trace the shift from reactive chemical control toward prevention, evidence, and integrated methods
- **Primary intent:** Understand IPM history
...
- **Scope boundary:** Excludes current legal requirements; BAS-18-A01 owns regulation
- **Final public route:** `/artikel/sejarah-pengendalian-hama-dan-ipm.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Dari Pembasmian Massal ke IPM: Evolusi Pengendalian Hama**.
...
- **Tie back to this article:** Keep the explanation specific to “Dari Pembasmian Massal ke IPM: Evolusi Pengendalian Hama”.
