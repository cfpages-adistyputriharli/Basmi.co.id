---
article_id: BAS-01-A04
title: "Matriks Risiko Hama untuk Rumah dan Tempat Usaha"
slug: "matriks-risiko-hama"
description: "Rate likelihood, consequence, exposure pathway, sensitive users, business impact, and urgency"
status: outline
publication_date: "2025-05-02"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: BAS-01
primary_intent: "Prioritize pest findings"
reader_community: "Basmi.co.id"
reader_address: "Sobat Basmi.co.id"
final_route: "/artikel/matriks-risiko-hama.html"
...
# Matriks Risiko Hama untuk Rumah dan Tempat Usaha

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Matriks Risiko Hama untuk Rumah dan Tempat Usaha”
- **Reader and situation:** Owner comparing several findings
- **Reader outcome:** Rate likelihood, consequence, exposure pathway, sensitive users, business impact, and urgency
- **Primary intent:** Prioritize pest findings
...
- **Scope boundary:** Excludes medical or legal conclusions; BAS-15-A01 and BAS-18-A01 own those contexts
- **Final public route:** `/artikel/matriks-risiko-hama.html`
- **Appointed CMS date:** `2025-05-02` (`editorial_backfill`; preserve exactly)
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Matriks Risiko Hama untuk Rumah dan Tempat Usaha**.
...
- `/category/disinfektan-rumah/` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- `BAS-01-A06` → `/artikel/format-laporan-survei-hama.html` — Format Laporan Survei Hama yang Bisa Diaudit
...
- **Tie back to this article:** Keep the explanation specific to “Matriks Risiko Hama untuk Rumah dan Tempat Usaha”.
