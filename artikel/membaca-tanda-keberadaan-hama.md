---
article_id: BAS-01-A03
title: "Kotoran, Jejak, Lubang, Bau, dan Kerusakan: Membaca Tanda Hama"
slug: "membaca-tanda-keberadaan-hama"
description: "Distinguish common sign categories and record age, distribution, and alternative explanations"
status: outline
publication_date: "2025-04-28"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: BAS-01
primary_intent: "Interpret pest signs"
reader_community: "Basmi.co.id"
reader_address: "Teman Basmi.co.id"
final_route: "/artikel/membaca-tanda-keberadaan-hama.html"
...
# Kotoran, Jejak, Lubang, Bau, dan Kerusakan: Membaca Tanda Hama

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Kotoran, Jejak, Lubang, Bau, dan Kerusakan: Membaca Tanda Hama”
- **Reader and situation:** Facility inspecting an empty area
- **Reader outcome:** Distinguish common sign categories and record age, distribution, and alternative explanations
- **Primary intent:** Interpret pest signs
...
- **Scope boundary:** Excludes species certainty from one sign; BAS-01-A02 owns identification evidence
- **Final public route:** `/artikel/membaca-tanda-keberadaan-hama.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Kotoran, Jejak, Lubang, Bau, dan Kerusakan: Membaca Tanda Hama**.
...
- `/jasa-pembasmi-tikus-bau-bau.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-pembasmi-tikus-bau-bau` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-pembasmi-tawon-bau-bau.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-pembasmi-tawon-bau-bau` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-pembasmi-serangga-bau-bau.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-pembasmi-serangga-bau-bau` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- `BAS-01-A02` → `/artikel/bukti-identifikasi-hama.html` — Cara Mengumpulkan Bukti untuk Identifikasi Hama Tanpa Menebak
...
- **Tie back to this article:** Keep the explanation specific to “Kotoran, Jejak, Lubang, Bau, dan Kerusakan: Membaca Tanda Hama”.
